...
const SYNTAX_FILES = [
  ...
  'scripts/test-release-cache-volume-counts-bridge.js',
  'scripts/test-release-volume-counts-total-bridge.js',
...
const RUN_CHECKS = [
  ...
  { label: 'Volume-Counts-Bruecke tests',              cmd: 'node', cmdArgs: ['scripts/test-release-cache-volume-counts-bridge.js'] },
  { label: 'Volume-Counts-Total-Bruecke tests (Phase 80)', cmd: 'node', cmdArgs: ['scripts/test-release-volume-counts-total-bridge.js'] },
