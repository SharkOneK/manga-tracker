...
| The Eminence in Shadow | Tokyopop | 11 | 1 | manual-source-required | manual-source-review | nein |
| Blood Blade | Hayabusa | 6 | 1 | manual-source-required | manual-source-review | nein |
| Yakuza Reincarnation | Manga Cult | 17 | 1 | manual-source-required | manual-source-review | nein |
...
| The Eminence in Shadow | Tokyopop | 11 | manual-source-required | manual-source-review | nein | ja |
| Blood Blade | Hayabusa | 6 | manual-source-required | manual-source-review | nein | ja |
| Yakuza Reincarnation | Manga Cult | 17 | manual-source-required | manual-source-review | nein | ja |
...
```json
{
  ...
  "gapAnalysis": [
    ...
    {
      "seriesTitle": "Yakuza Reincarnation",
...
| Hayabusa | 1 | 1 | Offizielle Verlags-/Produktquelle manuell pruefen; kein Cache-Patch ohne belegtes tagesgenaues Release-Datum. |
