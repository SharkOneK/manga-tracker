...
| The Rising of the Shield Hero | Tokyopop | 1 | 1 | manual-source-required | manual-source-review | nein |
| Frieren – Nach dem Ende der Reise | Altraverse | 1 | 1 | manual-source-required | manual-source-review | nein |
...
| The Rising of the Shield Hero | Tokyopop | 1 | manual-source-required | manual-source-review | nein | ja |
| Frieren – Nach dem Ende der Reise | Altraverse | 1 | manual-source-required | manual-source-review | nein | ja |
...
```json
{
  ...
  "gapAnalysis": [
    ...
    {
      "seriesTitle": "The Rising of the Shield Hero",
      "publisher": "Tokyopop",
      "volumeNumber": 1,
      "classification": "source-data-gap",
      "priority": "mittel",
    ...
    {
      "seriesTitle": "Frieren – Nach dem Ende der Reise",
      "publisher": "Altraverse",
      "volumeNumber": 1,
      "classification": "source-data-gap",
      "priority": "mittel",
